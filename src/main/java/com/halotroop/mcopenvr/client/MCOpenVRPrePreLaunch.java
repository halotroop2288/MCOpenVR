...
/**
 * Loads natives before any rendering calls are made, and initializes OpenVR before Minecraft starts
 *
 * @author halotroop2288
 */
@Environment(EnvType.CLIENT)
public class MCOpenVRPrePreLaunch implements PrePreLaunch {
